          ...
          <CardContent className="p-7">
            ...
            {googleDialogOpen && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                ...
                >
                  <Card className="glass-strong shadow-premium border-border/40">
                    <CardContent className="p-6">
                      <h2 className="text-lg font-bold mb-1">Continue with Google</h2>
                      <p className="text-sm text-muted-foreground mb-4">
                        Enter your details to sign in with Google
                      </p>
                      <form onSubmit={handleGoogleLogin} className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="flex-1 gradient-emerald text-white shadow-glow"
                          >
                            {googleLoading ? (
                              <Loader2 className="w-4 h-4 animate-spin" />
                            ) : (
